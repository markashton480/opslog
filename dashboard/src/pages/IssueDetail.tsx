        ...
        <div className="rounded-xl border border-indigo-200 bg-indigo-50/30 p-5 shadow-sm" data-testid="edit-form">
          ...
          <div className="mt-3 grid gap-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              <label className="mb-1 block text-xs font-medium text-slate-600">Symptoms</label>
              <textarea
            ...
            <div className="sm:col-span-2">
              <label className="mb-1 block text-xs font-medium text-slate-600">Solution</label>
              <textarea
